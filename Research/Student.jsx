...
//       <div className="pro-btn text-center my-4">
...
//         <h1 className="text-center mt-5 ms-5 ps-5">
//           Student <span style={{ fontFamily: "DM Serif Display", color: '#1152ae' }}>Research</span>
//         </h1>
